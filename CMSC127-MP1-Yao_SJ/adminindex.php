<?php
	...
	if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST["emailaddress"])) {
		...
		$sql = "SELECT * FROM teachers WHERE Email_Address = '$inputemailaddress' AND Password = '$inputPassword' AND ADMIN = TRUE"; 
		...
		if ($user) {
			...
			header("Location: teacher_crud.php");
			exit();
		} else {
...
<body>
	...
	<div class = "container">
		<img src="UP-System-UP-Cebu-Logo.png" alt="UP Logo"><br/>
	</div>	
